...
- ⚠️ **标注类指标尚未按 DeepSeek 重跑**:断言引用支持率 / 答案覆盖率目前只对 glm 时代那次运行标注过。因此正文出现的 **0.8238(100.5/122)是 glm-5.3 时代(2026-09-07)口径** —— 包括 §4 Phase 2 结果、§11 第七/八/九轮评审记录,以及 README 对应段落。**引用该数字时必须同时标明是 glm 时代**,不得当作当前模型能力;按新基线重标注已列入待办。
